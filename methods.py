...
def get_lesson_ids(s, course_id, group_id):
    ...
    lessons = s.get(
        url, params={"groupId": group_id, "courseId": course_id}
    ).json()
...
def get_material_html(s, lesson_id, group_id, material_id):
    ...
    material = s.get(
        url, params={"groupId": group_id, "lessonId": lesson_id}
    ).json()
...
def get_all_tasks(s, lesson_id, course_id):
    ...
    lesson_info = s.get(
        url, params={"courseId": course_id, "lessonId": lesson_id}
    ).json()
    return lesson_info
...
def get_courses_groups_ids(s):
    ...
    ids = list(
        {"course_id": course["id"], "group_id": course["group"]["id"]}
